...
public class WalkingDeliveryStrategy implements DeliveryStrategy {

    @Override
    public void deliver(Unicorn unicorn, Customer customer) {
        System.out.println("Dostawa: " + customer.getName() + " odbiera jednorożca "
                + unicorn.getName() + " osobiście ze stajni.");
    }
}
