...
public class BestRatedUnicornStrategy implements UnicornSelectionStrategy {

    @Override
    public Unicorn select(List<Unicorn> available, Customer customer) {
        System.out.println("Wybór jednorożca: Algorytm 'Najwyżej oceniany'");
        return available.stream()
                .max(Comparator.comparingDouble(Unicorn::getRating))
